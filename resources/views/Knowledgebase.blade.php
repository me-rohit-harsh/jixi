...
@section('content')
    <body class="lagom lagom-not-portal lagom-layout-top lagom-default page-knowledgebase " data-phone-cc-input="1">
                    ...
                    <div class="main-grid">
                        ...
                        <div class="main-content  ">
                            ...
                            <div class="search-box search-box-secondary">
                                <form role="form" method="post" action="/user/knowledgebase/search">
        ...
        c0,1.5,0.5,2.7,1.5,3.2l30,17.3" />
                                                ...
                                                <line class="svg-icon-prime svg-icon-stroke" x1="37" y1="35.5" x2="17"
                                                    y2="24" />
                                                <line class="svg-icon-prime svg-icon-stroke" x1="31" y1="38.1" x2="17"
                                                    y2="30" />
                                            </svg>
                                        </div>
