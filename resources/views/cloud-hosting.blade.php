...
<head>
    <title>Cloud Hosting - JiXi Cloud</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <section class="second-section bg-main has-bg">
            <div class="container">
                <div class="ss-wrapper text-center" style="max-width:700px;text-aling:center;margin:0 auto">
                    <h1 class="fsl-2 text-white" style="text-transform: none;">Cloud Hosting with 2X Faster Speed</h1>
                    <p class="s-desc text-white">#1 Cloud Hosting in India Powered by Linode Servers.</p>
                    <div class="gmj-btns flex text-center" style="justify-content: center;">
                        <a href="#view-plan" class="btn-secondry">Try Now &#8609;</a>
                    </div>
                </div>
            </div>
        </section>
        ...
        <style>
            ...
            .row .pcbtn {
                padding: 10px 25px;
                background-color: #A642AE;
                color: white;
                border: none;
                cursor: pointer;
            }

            .row .pcbtn:first-child {
                border-top-left-radius: 20px;
                border-bottom-left-radius: 20px;
            }

            .row .pcbtn:last-child {
                border-top-right-radius: 20px;
                border-bottom-right-radius: 20px;
            }

            .pcbtn.active {
                background-color: #630f69;
            }
        </style>

        <section id="view-plan" class="gmj-section p1">
            <div class="section-heding text-center pb-12 mb-1">
                <h2>Affordable <span style="color:#A642AE">Cloud Hosting</span> Plans</h2>
                <p class="line"></p>
                <p class="desc mb-1">Best cloud hosting with reliable infrastructure, scalability, and robust security..
                </p>
            </div>

            <div class="row" style="padding-bottom: 2rem;margin-bottom: 3rem">
                <button id="monthlyButton" class="pcbtn active">Monthly</button>
                <button id="yearlyButton" class="pcbtn">Yearly</button>
            </div>
            ...
            <div class="row home-plans hosting-price">
                <div class="column">
                    <div class="card no-border">
                        ...
                        <div class="yearlyp" style="display:none">
                            <div class="plan-price-del">
                                <del id="monthlyp"> ₹1799</del>
                                <div class="save" id="monthlyp">Save 22%</div>
                            </div>
                            <div class="planPrice" id="monthlyp">
                                <span>₹</span>1399<span class="monthText">/year</span>
                            </div>
                        </div>
                        <hr>
                        <ul>
                ...
                <div class="column">
                    <div class="card no-border">
                        ...
                        <div class="yearlyp" style="display:none">
                            <div class="plan-price-del">
                                <del id="monthlyp"> ₹2699</del>
                                <div class="save" id="monthlyp">Save 25%</div>
                            </div>
                            <div class="planPrice" id="monthlyp">
                                <span>₹</span>1999<span class="monthText">/year</span>
                            </div>
                        </div>
                        <hr>
                        <ul>
                            <li class="yearlyp" style="display:none">Free .COM Domain*</li>
                ...
                <div class="column">
                    <div class="card no-border">
                        ...
                        <div class="yearlyp" style="display:none">
                            <div class="plan-price-del">
                                <del>₹3999</del>
                                <div class="save">Save 37%</div>
                            </div>
                            <div class="planPrice">
                                <span>₹</span>2499<span class="monthText">/year</span>
                            </div>
                        </div>
                        <hr>
                        <ul>
            ...
            <p class="text-center" style="margin: 15px 0;padding: 10px 0 0;color: #057259;"><strong>*</strong> Free .COM
                Domain registration is available in yearly plans & offer not valid for domain transfer.</p>

            <div class="gmj-logos text-center">
                <div class="gmj-logos-wrapper">
                    <span class="gmj-logos-logo" style="">
                        <img class="img100" src="/assets/icons/linode.svg">
                    </span>
                    <span class="gmj-logos-logo" style="">
                        <img class="img100" src="/assets/icons/cpanel.svg">
                    </span>
                    <span class="gmj-logos-logo">
                        <img class="img100" src="/assets/icons/imunify360.svg">
                    </span>
                    <span class="gmj-logos-logo">
                        <img class="img100" src="/assets/icons/jetbackup.svg">
                    </span>
                    <span class="gmj-logos-logo">
                        <img class="img100" src="/assets/icons/softaculous.png">
                    </span>
                </div>
            </div>
  ...
  $("#monthlyButton").click(function() {
    $(".monthlyp").fadeIn().show();
    $(".yearlyp").fadeOut().hide();
