...
<head>
    <title>Domain Transfer - JiXi Cloud</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <section style="position:relative;" class="second-section bg-main">
            <div class="container" style="padding-bottom: 3rem;">
                <div class="ss-wrapper text-center">
                    <h1 class="fsl-2 text-white">Transfer YOUR DOMAIN NOW!</h1>
                    <p class="s-desc text-white">Hassle-free domain transfer at very affordable price</p>
                    <span class="ss-4">
                        ...
                        <div class="main-domain" style="border:none;box-shadow:none"></div>
                    </span>
                </div>
            </div>
            ...
            <div class="row top-domains">
                ...
                <div class="column">
                    <div class="card no-border">
                        ...
                        <h3>₹849/year</h3>
                        <div class="offer-product-price-info">Instead of Rs949</div>
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="card no-border">
                        ...
                        <h3>₹699/year</h3>
                        <div class="offer-product-price-info">Instead of Rs725</div>
                    </div>
                </div>
                <div class="column">
                    <div class="card no-border">
                        ...
                        <h3>₹2599/year</h3>
                        <div class="offer-product-price-info">Instead of Rs2599</div>
                    </div>
                </div>
                ...
                <div class="column">
                    <div class="card no-border">
                        ...
                        <h3>₹549/year</h3>
                        <div class="offer-product-price-info">Instead of Rs549</div>
                    </div>
                </div>
                <div class="column">
                    <div class="card no-border">
                ...
                <div class="column">
                    <div class="card no-border">
                        ...
                        <h3>₹1899/year</h3>
                        <div class="offer-product-price-info">Instead of Rs1899</div>
                    </div>
                </div>
                <div class="column">
                    <div class="card no-border">
                        ...
                        <h3>₹1299/year</h3>
                        <div class="offer-product-price-info">Instead of Rs1299</div>
                    </div>
                </div>
                <div class="column">
                    <div class="card no-border">
